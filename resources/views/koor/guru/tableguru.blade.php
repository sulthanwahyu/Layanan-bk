            ...
            <div class="page-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>Table Guru</h5>
                        <a class="btn btn-default" href="{{route('cetakguru')}}" target="_blank"><i class="fa fa-print"></i> Cetak PDF</a>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                  ...
                                  <td style="display: flex; gap: 5px">
                                    <a href="/guru/edit/{{$data->id}}"><i class="fa-solid fa-pen"></i></a>
                                    <form action="/guru/destroy/{{$data->id}}" method="POST" onsubmit="return confirm('yakin hapus?')">
                                      @csrf
                                      @method('DELETE')
