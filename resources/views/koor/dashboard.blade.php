    ...
    <div class="pcoded-inner-content">
        ...
        <div class="main-body">
            ...
            <div class="profile-container">
              <img class="profile-picture" src="{{ Auth()->user()->profile_photo_url }}">
             <a href="/editkoor"><i class="fa-solid fa-pen-to-square" style="position:absolute;left:74%;font-size:150%;top:15%"></i></a> 
