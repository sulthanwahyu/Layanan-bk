                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form-valide-with-icon" action="/petaguru/up/{{$petakerawanan->id}}" method="post">
                                    @csrf
                                    @method('PUT')
                                  <div class="form-group">
                                    <label class="form-label">Jenis Kerawanan</label>
                                    <input name="jenis_kerawanan" value="{{$petakerawanan->jenis_kerawanan}}" type="text" class="form-control">
                                  </div>
                                  {{-- <div class="form-group">
                                    <label  class="form-label">NIPD</label>
                                    <input name="nipd_id" value="{{$petakerawanan->nipd_id}}" type="text" class="form-control" >
                                  </div>
                                    <div class="form-group">
                                    <label  class="form-label">NIPD</label>
                                    <input name="nipd_id" value="{{$petakerawanan->nipd_id}}" type="text" class="form-control" >
