                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form-valide-with-icon" action="/jadwalguru/up/{{$jadwal->id}}" method="post">
                                    @csrf
                                    @method('PUT')
                                  <div class="form-group">
                                    <label class="form-label">Tanggal</label>
                                    <input name="tanggal_konseling" value="{{$jadwal->tanggal_konseling}}" type="date" class="form-control">
                                  </div>
                                  <div class="form-group">
                                    <label  class="form-label">Deskripsi</label>
                                    <input name="deskripsi" value="{{$jadwal->deskripsi}}" type="text" class="form-control" >
                                  </div>
                                  {{-- <div class="form-group">
