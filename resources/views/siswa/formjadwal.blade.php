    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="basic-form">
                <form class="form-valide-with-icon" action="/add_jadwal" method="POST">
                        @csrf
                        <div class="mb-3">
                        <label for="disabledSelect" class="form-label">Layan</label>
                      ...
                      <div class="form-group">
                        ...
                        <select id="disabledSelect" class="form-select" name="nipd_id">
                      ...
                      <div class="form-group">
                        ...
                        <input name="tanggal_konseling" type="date" class="form-control">
                      </div>     
